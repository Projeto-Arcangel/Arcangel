...
abstract class FlutterFlowTheme {
  ...
  late Color history;
  late Color sociology;
  late Color philosophy;
  late Color geography;
  late Color botaoLogin;
  late Color botaoLoginText;
  late Color cadeado;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFFFFFF0);
  late Color alternate = const Color(0xFFD9D9D5);
  late Color primaryText = const Color(0xFF1E1F28);
  ...
  late Color history = const Color(0xFF6F574A);
  late Color sociology = const Color(0xFFEAD47F);
  late Color philosophy = const Color(0xFFFFFFFF);
  late Color geography = const Color(0xFF72D082);
  late Color botaoLogin = const Color(0xFFFFFFF1);
  late Color botaoLoginText = const Color(0xFFD9D9D7);
  late Color cadeado = const Color(0xFF888888);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF282932);
  late Color secondary = const Color(0xFF282932);
  late Color tertiary = const Color(0xFF4B4C53);
  ...
  late Color history = const Color(0xFF6F574A);
  late Color sociology = const Color(0xFFEAD47F);
  late Color philosophy = const Color(0xFFD9D9D9);
  late Color geography = const Color(0xFF72D082);
  late Color botaoLogin = const Color(0xFFD9D9D8);
  late Color botaoLoginText = const Color(0xFF282933);
  late Color cadeado = const Color(0xFF95A1AC);
}
